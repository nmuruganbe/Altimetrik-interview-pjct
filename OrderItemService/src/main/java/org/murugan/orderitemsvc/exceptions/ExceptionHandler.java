...
/**
 * Customized exception handler for handling all the exceptions and returns meaningful messages to the clients.
...
public class ExceptionHandler extends ResponseEntityExceptionHandler {
	...
	/**
	 * To handle {@link OrderItemNotFoundException}
	 * @param ex
	 * @param request
	 * @return
	 * @throws Exception
	...
	public final ResponseEntity<ExceptionResponseTemplate> handleOrderItemNotFoundException(Exception ex,
	...
	public final ResponseEntity<ExceptionResponseTemplate> handleInvalidInputException(Exception ex,
			WebRequest request) throws Exception {
		ExceptionResponseTemplate exceptionTemplate = new ExceptionResponseTemplate(ex.getMessage(),
				request.getDescription(false), new Date());
	...
	/**
	 * To handle all other {@link Exception}
	 * @param ex
	 * @param request
	 * @return
	 * @throws Exception
	...
	public final ResponseEntity<ExceptionResponseTemplate> handleAllExceptions(Exception ex,
			WebRequest request) throws Exception {
		ExceptionResponseTemplate exceptionTemplate = new ExceptionResponseTemplate(ex.getMessage(),
				request.getDescription(false), new Date());
